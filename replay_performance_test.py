...
exporters = {
    ...
    "argus": {
        "name": "argus",
        "shell": True,
        "cmd": "/users/mverkerk/RustiFlow-experiments/argus_script_realtime.sh {interface} {interface}_argus.csv > {output_folder}/argus_realtime_{throughput}.log 2>&1",
        "cwd": None,  # Runs from any directory
    },
