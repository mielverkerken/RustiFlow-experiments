...
Using the `pcap_run.sh` you can execute the experiments on pcap samples of all the days. Then run `python3 pcap_performance_test.py <exporter> /data/cicids2017 --pcap cicids2017`
