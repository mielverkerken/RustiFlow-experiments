...
Using the `./pcap_run.sh <exporter>` you can execute the experiments on pcap samples of all the days. Then run `python3 pcap_performance_test.py <exporter> /data/cicids2017 --pcap cicids2017`. Finally, run `./copy_pcap_results.sh <exporter>` and `cp /data/cicids2017/<exporter>_cicids2017_metrics.csv results/pcap/<exporter>/cicids2017/1_<exporter>_cicids2017_metrics.csv` to copy the result files to idlab share.
